...
export default function Home() {
  return (
    <main className="bg-gray-50 text-gray-800">
      {/* Hero */}
      <section className="min-h-screen flex items-center justify-center text-center px-6 bg-gradient-to-br from-blue-600 to-blue-900 text-white">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AgendApp — Seu sistema de agendamento online
          </h1>
          <p className="text-lg md:text-xl mb-8">
            Transforme sua rotina com agendamentos automatizados e sem
            complicação.
          </p>
          <Link
            href="/agendar"
          ...
          >
            <button
              type="button"
              className="btn bg-white hover:bg-gray-200 transition"
            >
              Começar agora
            </button>
          </Link>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 border rounded-xl">
              <p className="mb-4 italic">
                “Desde que comecei a usar o AgendApp, minha agenda ficou
                organizada e os clientes adoraram a praticidade!”
              </p>
              <span className="font-semibold">— Camila, terapeuta</span>
            </div>
            <div className="p-6 border rounded-xl">
              <p className="mb-4 italic">
                “Simplesmente incrível! Consegui centralizar tudo em um só lugar
                e reduzir drasticamente os esquecimentos de horários.”
              </p>
      ...
      <section className="py-20 px-6 bg-blue-700 text-white text-center">
        ...
        <Link href="/agendar" className="bg-white text-blue-600 font-semibold">
          <button
            type="button"
            className="btn bg-white hover:bg-gray-200 transition"
          >
